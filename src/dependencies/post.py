...
from repositories import PostRepository, CommentRepository, LikeRepository, FavoriteRepository, PostMediaRepository
...
async def get_post_service(
    ...
    return PostService(post_repo, post_media_repo, comment_repo, like_repo, favorite_repo)
